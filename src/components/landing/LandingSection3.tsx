  ...
  return (
    ...
    >
      ...
      >
        ...
        <img
          loading="lazy"
          src="img/landingPage/CN/CN_main_graph.webp"
        ...
        <img
          loading="lazy"
          src="img/landingPage/main_yellow_arrow.webp"
      ...
      >
        ...
        >
          <img
            loading="lazy"
            src="img/landingPage/CN/CN_main_people1.webp"
        ...
        >
          <img
            loading="lazy"
            src="img/landingPage/CN/CN_main_people2.webp"
            className="object-contain max-w-full aspect-square w-[260px] h-[277px] 
            max-md:h-[250px] max-sm:h-[220px]"
            alt="pink arrow"
          />
