...
const LandingSection4 = ({
  ...
  return (
    <section
      className="flex flex-col items-center t-12 text-center font-bold cursor-default px-[1rem] pb-2
    max-lg:w-full max-lg:px-[1rem] max-lg:pb-3 max-md:w-full max-md:px-[1rem] max-md:mt-0 max-sm:mt-0"
    >
      <img
        loading="lazy"
        src="img/landingPage/main_hand.webp"
        alt="main_hand"
      ...
      >
        <img
          loading="lazy"
          src="img/landingPage/CN/CN_main_result.webp"
      ...
      <img
        loading="lazy"
        src="img/landingPage/main__line.webp"
        alt="main__line"
