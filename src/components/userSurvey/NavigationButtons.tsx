...
const NavigationButtons = ({
  ...
  return (
    <div className="flex justify-center gap-5 self-center mt-11 max-w-full text-center">
      <div
        className="px-10 py-3.5 text-white bg-rose-400 rounded max-md:px-5 cursor-pointer"
        onClick={onPrevious}
        style={{
      ...
      <div
        className="px-10 py-3.5 text-rose-400 bg-white rounded border-2 border-rose-400 border-solid max-md:px-5 cursor-pointer"
        onClick={handleNext}
      >
