    ...
    <header className="flex  gap-5 justify-between w-full bg-wellcome-white text-center whitespace-nowrap  max-md:max-w-full">
      <Link href="/">
        <div className="flex gap-7 p-2.5 text-xl font-extrabold text-rose-400">
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/79f58222dea8a08782d31a3d0097d70e847bc7291bdb5fe7cd7606f9bb278ecc?placeholderIfAbsent=true&apiKey=e0c395b96452442183c02ce725ff7111"
